...
class Atri:
	def __init__(self, state: Any):
		...
		self.Navbar_Items = state["Navbar_Items"]
	...
	def Navbar_Items(self):
		self._getter_access_tracker["Navbar_Items"] = {}
		return self._Navbar_Items
	@Navbar_Items.setter
	def Navbar_Items(self, new_state):
		self._setter_access_tracker["Navbar_Items"] = {}
		global default_state
		self._Navbar_Items = Div(new_state, default_state["Navbar_Items"])
	...
	def _to_json_fields(self):
		return {
			"Navbar": self._Navbar,
			"logo": self._logo,
			"Navbar_Items": self._Navbar_Items,
			"Flex4": self._Flex4,
			"Flex11": self._Flex11,
			"Div29": self._Div29,
			"Div30": self._Div30,
